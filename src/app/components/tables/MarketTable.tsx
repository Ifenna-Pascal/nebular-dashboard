...
// import WalletInfoCardApy from '@/app/sections/home/walletInfoCardApy';
...
//                 <tr
//                   key={index}
//                   className="   hover:bg-[#FFFFFF0D] cursor-pointer mb-5 "
//                   onClick={() => router.push(`/market/${index}`)}
//                 >
//                   <td className="lg:px-6 py-10 flex items-center">
//                     <Image
//                       src={assets.usdtIcon}
//                       alt="coin-icon"
//                       width={24}
...
//                       className="w-5 "
//                     />
//                     <span className="ml-3 text-[8px] md:text-[14px] font-montserrat xl:text-[18px] text-white">
//                       {data.name}
//                     </span>
//                   </td>
//                   <td className="px-6 py-5 text-[8px] md:text-[14px] font-montserrat xl:text-[18px] text-white">
//                     {data.collateral}
//                   </td>
//                   <td className="px-6 py-5 text-[8px] md:text-[14px] font-montserrat xl:text-[18px] text-white">
//                     {data.tvl}
  ...
  return (
    <div className="overflow-x-auto px-4 md:px-10">
      <div className="border border-[#302E2E] bg-gradient-to-b from-[#0303033B] to-[#31324282] shadow-md min-h-[400px] rounded-lg px-8">
        ...
        <div className="overflow-auto">
          <table className="min-w-[550px] lg:min-w-full border-separate border-spacing-y-10">
            <thead>
              <tr className="h-[45px] lg:h-[85px] mt-4 lg:mt-0">
                {[
                  'Assets',
            ...
            <tbody>
              {marketTable.map((data, index) => (
                <tr
                  ...
                  onClick={() => router.push(`/market/${index}`)}
                >
                  <td className="lg:px-6 py-5 flex items-center">
                    <Image
                      src={assets.usdtIcon}
                      alt="coin-icon"
                      width={24}
