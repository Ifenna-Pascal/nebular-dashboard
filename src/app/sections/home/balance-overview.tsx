...
const BalanceOverview = () => {
  return (
    <div className='p-12'>
        ...
        <h1 className='font-montserrat text-[48px] text-white font-bold'>Ethereum</h1>
        <Image src={assets.arrowDownIcon} alt='arrow-down' width={15} className='w-[15px] ml-2 mt-2' />   
        </div>
        ...
        <div className='mt-6 flex w-full justify-between items-center'>
            <WalletInfoCardApy apy='-------' text='Your Suppply Balance' value='0.00' />
            <WalletInfoCardApy apy='-------' text='Your Borrow Balance' value='0.00' />
        </div>
    </div>
  )
}
