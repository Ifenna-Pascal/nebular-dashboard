...
const WalletInfoCard = ({text, value, styles}:IWalletCard) => {
  return (
    <div className={`lg:w-[530px] flex items-center justify-between bg-light-10 rounded-[15px] px-8 ${styles}`}>
         <div className="flex items-center">
                    <Image src={assets.ethIcon} alt='eth-icon' width={40} className='w-[40px] mr-3' />
