...
const WalletInfoCardApy: FC<IWalletAPY> = ({ text, apy, value, styles }) => {
  return (
    <div
      className={`lg:w-[530px] flex items-center justify-between h-[118px] bg-light-10 rounded-[15px] px-8 ${styles}`}
    >
      ...
      <div className="flex items-center flex-col">
        ...
        <span className="font-montserrat text-white mt-2 text-[16px]">
          {apy}
        </span>
      </div>
    </div>
